...
public class Employee {
	...
	public String toString() {
		return "사번 : " + empId + "/ 사원명 : " + empName + "/ 주민번호 : " + empNo + "/ 이메일 : " + email
				+ "/ 핸드폰 :" + phone + "/ 부서명 : " + departmentTitle + "/ 직급명 : " + jobName + "/ 급여 : "
				+ salary + "/ 부서코드 : " + deptCode + "/ 직급코드 : " + jobCode + "/ 급여등급 : " + salLevel + "/ 보너스 : "
				+ bonus + "/ 사수 사번 : " + managerId;
	}
